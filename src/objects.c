...
SCROLL("identify",                  "KERNOD WEL",  1, 165,  20),
...
SCROLL("building",                     "KCAHTEN",  1,  15, 300),
...
SPELL("building",        "blueprint",
      P_MATTER_SPELL,      10,  6, 5, 1, NODIR, HI_PAPER),
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      40,  2, 2, 1, RAY, HI_PAPER),
...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 45,  1, 1, 1, RAY, HI_PAPER),
...
WAND("building" ,    "titanium", 10, 300, 1, NODIR, IRON, HI_METAL),
